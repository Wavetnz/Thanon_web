...
<head>
  ...
  <div class="position-relative overflow-hidden p-3  text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 fw-normal">กิจกรรม</h1>
    </div>
...
<div class="row featurette">
  <div class="col-md-7">
    <h2 class="featurette-heading fw-normal lh-1">หล่อเทียนเข้าพรรษา</h2>
    <p class="lead">กิจกรรมหล่อเทียนเข้าพรรษาที่มหาวิทยาลัยเทคโนโลยีราชมงคล ล้านนา ตาก</p>
  </div>
  <div class="col-md-5">
  <img src="<?php echo base_url('img');?>/it.jpg" alt="" width="500" height="380">
...
<div class="row featurette">
  <div class="col-md-7 order-md-2">
    <h2 class="featurette-heading fw-normal lh-1">วันไหว้ครู</h2>
    <p class="lead">กิจกรรมวันไหว้ครูที่มหาวิทยาลัยเทคโนโลยีราชมงคล ล้านนา ตาก</p>
  </div>
  <div class="col-md-5 order-md-1">
  <img src="<?php echo base_url('img');?>/cru.jpg" alt="" width="500" height="320">
